...
function GetStringOrThrow(item) {
...
function GetFoodItems(foodItems) {
  if (!foodItems) return []
  return foodItems
    .split(':')
...
async function SeedFoodTrucks(foodTrucks) {
  try {
